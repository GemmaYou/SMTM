...
import Add from "./addNewActivity/add";
import AddOnce from "./addNewActivity/addOnce";
import AddPeriod from "./addNewActivity/addPeriod";
        ...
        <div>
          ...
          <div className="main" id="backToTop">
              <Switch>
                  ...
                  <Route path="/add">
                    {this.state.user.login ? <Add additem={this.state.additem} addOnChangeName={this.addOnChangeName.bind(this)} addOnChangeKind={this.addOnChangeKind.bind(this)} addOneToTwo={this.addOneToTwo.bind(this)} /> : <Redirect to="/" />}
                  </Route>
                  <Route path="/addOnce">
                  ...
                  <div className="homePage">
                    <section>
                      <div className="homePageIntro">
                        ...
                        <img src="/src/img/home.jpg" className="animate__animated animate__fadeInRight"/>
                        <div className="scroll"><a href="#intro1"><img src="/src/img/down-arrow.png" className="animate__animated animate__fadeIn" /></a></div>
                      </div>
                    </section>
                    <section id="intro1">
                      <div className="belowIntro1">
                        ...
                        <div className="scroll-down"><a href="#intro2"><img src="/src/img/down-arrow.png" className="animate__animated animate__fadeIn" /></a></div>
                      </div>
                    </section>
                    <section id="intro2">
                      <div className="belowIntro2">
                        ...
                        <div className="scroll-down"><a href="#intro3"><img src="/src/img/down-arrow.png" className="animate__animated animate__fadeIn" /></a></div>
                      </div>
                    </section>
                    <section id="intro3">
                      <div className="belowIntro1">
                        ...
                        <div className="scroll-down last-scroll"><a href="#backToTop"><img src="/src/img/down-arrow.png" className="animate__animated animate__fadeIn" /></a></div>
                      </div>
                    </section>
                    {this.state.modal ? <div id="myModal" className="modal">
                      <div className="modal-content">
                        <span className="close" onClick={this.closeHomepageSignin}>
                          ...
                          <SigninModal user={this.state.user} sub={this.sub} signin={this.signin} anonymous={this.anonymous}/>
                      </div>
                    </div> : <></>}
                  </div>
                </Route>
